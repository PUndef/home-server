#!/usr/bin/env python3
"""Set Beszel hub system host to phoneserver eth IP (192.168.1.227)."""
...
HOST = os.environ.get("PHONE_LAN_IP", "192.168.50.127")
...
def main() -> int:
    ...
    sql = (
        f"UPDATE systems SET host='{HOST}' WHERE name LIKE 'Phoneserver%';"
        f"SELECT id,name,host,status FROM systems WHERE name LIKE 'Phoneserver%';"
    )
