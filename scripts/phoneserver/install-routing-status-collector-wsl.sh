...
cp "$_repo/scripts/openwrt/watch_destiny_sessions.py" "$_staging/"
cp "$_repo/config/openwrt/overrides.json" "$_staging/"
cp "$_repo/scripts/phoneserver/routing-status-collector.sh" "$_staging/"
cp "$_repo/scripts/phoneserver/destiny-net-watch-collector.sh" "$_staging/"
...
cp "$_repo/scripts/phoneserver/destiny-net-watch-collector.service" "$_staging/"
